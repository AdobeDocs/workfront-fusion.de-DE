---
title: Verbinden von Adobe Workfront Fusion mit Webservices mit API-Token-Autorisierung
...
# Verbinden von Adobe Workfront Fusion mit Webservices mit API-Token-Autorisierung
...
1. Um eine Nachricht mithilfe von Workfront Fusion zu pushen, richten Sie das HTTP-Modul wie folgt ein.
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      <td role="rowheader"> <p> Header</p> </td> 
