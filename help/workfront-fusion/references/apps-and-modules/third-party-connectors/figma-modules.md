---
title: Figma-Module
description: Mit den Adobe Workfront Fusion Figma-Modulen können Sie Listen von Kommentaren, Dateien, Dateiversionen oder Projekten abrufen. Sie können auch einen Kommentar posten oder einen Aufruf an die Figma-API durchführen.
author: Becky
...
>[!IMPORTANT]
>
>* Die Figma änderte im Januar 2025 ihre Authentifizierungspflichten. Der `Figma` Verbindungstyp erfüllt die neuen Anforderungen. Der `Figma (Legacy)` Verbindungstyp ist veraltet und wird in naher Zukunft entfernt.
>* Wenn Sie eine Umleitungs-URL verwenden, verwenden Sie `https://oauth.app.workfrontfusion.com/oauth/cb/figma3`.
...
<table style="table-layout:auto"> 
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Geben Sie die maximale Anzahl von Kommentaren ein, die das Modul während jedes Ausführungszyklus eines Szenarios zurückgeben soll, oder ordnen Sie eine Zahl zu.</td>
    </tr>
  </tbody>
</table>
