---
title: Slack-Module
description: In einem  [!DNL Adobe Workfront Fusion]  können Sie Workflows automatisieren, die Slack verwenden, und es mit mehreren Anwendungen und Services von Drittanbietern verbinden.
author: Becky
...
Der Slack-Anschluss verwendet Folgendes:
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Geben Sie die Kanal-ID ein (zuordnen).</p> <p>Hinweis: Die Kanal-ID kann über das Modul [!UICONTROL List Channels] abgerufen werden.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Message ID (Time stamp)]</p> </td> 
   <td> <p> Geben Sie den Zeitstempel der Nachricht ein, zu der Sie Informationen abrufen möchten, oder ordnen Sie ihn zu.</p> <p>Hinweis: Der Zeitstempel kann mit einem anderen Modul abgerufen werden, z. B. mit dem [!UICONTROL Watch Public Channel].</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Channel ID]</p> </td> 
   <td> <p>Geben Sie die Kanal-ID ein oder mappen Sie sie.</p> <p>Hinweis: Die Kanal-ID kann über das Modul [!UICONTROL List Channels] abgerufen werden.</p> </td> 
  </tr> 
  <tr> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Wählen Sie aus, wie Sie den Kanal auswählen möchten, in dem Sie eine Nachricht erstellen möchten.</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p>Geben Sie im Feld <strong>[!UICONTROL Channel ID or name]</strong> die Kanal-ID oder den Namen des Kanals ein, in dem Sie die Nachricht posten möchten, oder ordnen Sie sie zu.</p> <p>Hinweis: Die Kanal-ID kann über das Modul [!UICONTROL List Channels] abgerufen werden.</p> </li> 
     <li> <p><strong>[!UICONTROL Select from the list]</strong> </p> <p>Wählen Sie den Kanaltyp und dann den Kanal aus.</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>Aktivieren Sie diese Option, um automatisches Parsen zu ermöglichen. </p> <p>Weitere Informationen finden Sie unter <a href="https://api.slack.com/docs/formatting">Text für Programmoberflächen formatieren</a> in der [!DNL Slack].</p> <p>Hinweis: Wenn Sie in der ursprünglichen Nachricht [!UICONTROL Link names]- oder [!UICONTROL Parse message text]-Optionen verwendet haben, sollten Sie diese auch beim Ausführen des [!UICONTROL Update a Message] angeben.</p> </td> 
  </tr> 
  <tr> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Wählen Sie aus, wie Sie die Nachricht auswählen möchten.</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p>Geben Sie im Feld <strong>[!UICONTROL Channel ID or name]</strong> die Kanal-ID oder den Kanal, der die Nachricht enthält, ein oder ordnen Sie sie zu und geben Sie dann den <strong>[!UICONTROL Time Stamp (Message ID)]</strong> der Nachricht ein. .</p> <p>Hinweis: Die Kanal-ID kann über das Modul [!UICONTROL List Channels] abgerufen werden.</p> </li> 
     <li> <p><strong>[!UICONTROL Select from the list]</strong> </p> <p>Wählen Sie den Kanaltyp aus, wählen Sie dann den Kanal und dann die Nachricht aus.</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Text]</p> </td> 
  ...
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Parse message text]</p> </td> 
   <td> <p>Aktivieren Sie diese Option, um automatisches Parsen zu ermöglichen. </p> <p> Weitere Informationen finden Sie unter <a href="https://api.slack.com/docs/formatting">Text für Programmoberflächen formatieren</a> in der [!DNL Slack].</p> <p>Hinweis: Wenn Sie in der ursprünglichen Nachricht [!UICONTROL Link names]- oder [!UICONTROL Parse message text]-Optionen verwendet haben, sollten Sie diese auch angeben, wenn Sie das Modul Nachricht aktualisieren ausführen.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Channel ID]</p> </td> 
   <td> <p>Geben Sie die ID des Kanals ein, über den Sie Informationen abrufen möchten, oder ordnen Sie sie zu.</p> <p>Hinweis: Die Kanal-ID kann über das Modul [!UICONTROL List Channels] abgerufen werden.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL Channel type]</td> 
   <td>Wählen Sie den Kanaltyp aus, der die Liste der Mitglieder enthält, die Sie auflisten möchten.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL Limit] </td> 
   <td> <p>Legen Sie die maximale Anzahl an Mitgliedern fest, die [!DNL Workfront Fusion] während eines Ausführungszyklus zurückgeben.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
* **Privater Kanal**: zuvor [!UICONTROL Group]
* **Direktnachricht**: Zuvor [!UICONTROL IM]
* **Channel**: [!UICONTROL Conversation] in der API-Dokumentation, [!UICONTROL channel] in der [!DNL Slack] App.
