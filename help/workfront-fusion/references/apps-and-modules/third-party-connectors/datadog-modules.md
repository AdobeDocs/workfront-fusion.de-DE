...
description: In einem Adobe Workfront Fusion-Szenario können Sie Workflows automatisieren, die Datadog verwenden, und es mit mehreren Anwendungen und Services von Drittanbietern verbinden.
author: Becky
...
In einem Adobe Workfront Fusion-Szenario können Sie Workflows automatisieren, die [!DNL Datadog] verwenden, und diese mit verschiedenen Anwendungen und Services von Drittanbietern verbinden.
...
## Verbinden von [!DNL Datadog] mit Workfront Fusion {#connect-datadog-to-workfront-fusion}

### Abrufen Ihres API-Schlüssels und Anwendungsschlüssels {#retrieve-your-api-key-and-application-key}

Um Ihr [!DNL Datadog]-Konto mit Workfront Fusion zu verbinden, müssen Sie einen API-Schlüssel und einen Anwendungsschlüssel aus Ihrem [!DNL Datadog]-Konto abrufen.
...
### Erstellen einer Verbindung zu [!DNL Datadog] in Workfront Fusion
...
Beim Konfigurieren von [!DNL Datadog]-Modulen werden in Workfront Fusion die unten aufgeführten Felder angezeigt. Darüber hinaus können abhängig von Faktoren wie Ihrer Zugriffsebene in der Anwendung oder im Service weitere [!DNL Datadog]-Felder angezeigt werden. Ein fett formatierter Titel in einem Modul kennzeichnet ein Pflichtfeld.
...
<table style="table-layout:auto">
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>Anweisungen zum Verbinden Ihres [!DNL Datadog]-Kontos mit Workfront Fusion finden Sie in diesem Artikel unter <a href="#connect-datadog-to-workfront-fusion" class="MCXref xref">Verbinden von [!DNL Datadog] mit Workfront Fusion</a>.</p> </td> 
  </tr> 
  <tr> 
