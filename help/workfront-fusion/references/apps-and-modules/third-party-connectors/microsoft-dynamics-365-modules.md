   ...
   <table style="table-layout:auto"> 
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>Geben Sie Ihre [!DNL Microsoft Dynamics] [!UICONTROL Client Secret] ein.
        </tr>
        <tr>
...
<table style="table-layout:auto"> 
 ...
 <tbody> "
  ...
  <tr> 
   ...
   <td>Wählen Sie aus, ob das Modul <strong>[!UICONTROL New Records Only]</strong>, <strong>[!UICONTROL Updated Records Only]</strong> oder <strong>[!UICONTROL New and Updated Records]</strong> sehen soll.</td> 
  </tr> 
  <tr> 
