...
## Verbinden [!UICONTROL Trello] mit Workfront Fusion

Anweisungen zum Verbinden Ihres [!UICONTROL Trello]-Kontos mit Workfront Fusion finden Sie unter [Erstellen einer Verbindung zu Adobe Workfront Fusion - Grundanweisungen](/help/workfront-fusion/create-scenarios/connect-to-apps/connect-to-fusion-general.md)
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> Geben Sie die maximale Anzahl an Boards ein, die Workfront Fusion während eines Ausführungszyklus zurückgeben soll. Dieser Wert muss kleiner oder gleich 1.000 sein.</p>  </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> Geben Sie die maximale Anzahl an Karten ein, die Workfront Fusion während eines Ausführungszyklus zurückgeben soll, oder mappen Sie sie. Dieser Wert muss kleiner oder gleich 1.000 sein.</p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> Geben Sie die maximale Anzahl von Kommentaren ein, die Workfront Fusion während eines Ausführungszyklus zurückgeben soll.</p> </td> 
  </tr> 
  <tr> 
