---
title: GitHub-Module
description: In einem Adobe Workfront Fusion-Szenario können Sie Workflows automatisieren, die GitHub verwenden, und es mit mehreren Anwendungen und Services von Drittanbietern verbinden.
author: Becky
...
In einem Adobe Workfront Fusion-Szenario können Sie Workflows automatisieren, die [!UICONTROL GitHub] verwenden, und sie mit mehreren Anwendungen und Services von Drittanbietern verbinden.
...
## Verbinden von [!DNL GitHub] mit Workfront Fusion
...
Beim Konfigurieren von [!DNL GitHub] zeigt Workfront Fusion die unten aufgeführten Felder an. Darüber hinaus können abhängig von Faktoren wie Ihrer Zugriffsebene in der App oder dem Service weitere [!DNL GitHub] angezeigt werden. Ein fett gedruckter Titel in einem Modul gibt ein erforderliches Feld an.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> Legen Sie die maximale Anzahl von Kommentaren fest, die Workfront Fusion während eines Zyklus zurückgibt.</p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL Maximale Anzahl der zurückgegebenen Probleme]</td> 
   <td> <p> Legen Sie die maximale Anzahl von Problemen fest, die Workfront Fusion während eines Zyklus zurückgibt.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Uhr]</td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> Legen Sie die maximale Anzahl von Pull-Anforderungen fest, die Workfront Fusion während eines Zyklus zurückgibt.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL -Status]</td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> Legen Sie die maximale Anzahl von Repositorys fest, die Workfront Fusion während eines Zyklus zurückgibt.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Uhr]</td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>Das Modul gibt die Kommentare zurück, die nach diesem Datum erstellt wurden. Eine Liste der unterstützten Datumsformate finden Sie unter <a href="/help/workfront-fusion/references/mapping-panel/data-types/type-coercion.md" class="MCXref xref">Typzwang</a>.</td> 
  </tr> 
  <tr> 
