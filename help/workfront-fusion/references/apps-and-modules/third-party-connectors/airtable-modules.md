...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> <p>Eintrag</p> </td> 
   <td> <p>Geben Sie die Werte für den neuen Datensatz ein. Die verfügbaren Felder basieren auf der von Ihnen ausgewählten Tabelle.</p> 
   <!--
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> <p>Eintrag</p> </td> 
   <td> <p>Geben Sie die Werte für den neuen Datensatz ein. Die verfügbaren Felder hängen von der ausgewählten Tabelle ab.</p> 
   <!--
