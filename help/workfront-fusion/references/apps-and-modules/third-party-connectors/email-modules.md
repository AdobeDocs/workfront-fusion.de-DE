...
1. Geben Sie den **[!UICONTROL User name]** und Ihre **[!UICONTROL Password]** für das E-Mail-Konto ein.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Geben Sie den E-Mail-Inhalt im HTML-Format mithilfe von HTML-Tags oder im Klartext ein oder mappen Sie ihn.</p> </td> 
  </tr> 
  <tr> 
   ...
   <td> <p>Klicken Sie für jeden Anhang, den Sie hinzufügen möchten<b> auf „Element hinzufügen</b> und geben Sie Folgendes ein:</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL File name]</strong> </p> <p>Geben Sie den Dateinamen einschließlich der Erweiterung ein. </p> </li> 
     <li> <p><strong>[!UICONTROL Data]</strong> </p> <p>Geben Sie den Pfad zu dem Ordner ein, in den Sie die Anlage hochladen möchten.</p> </li> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Email ID (UID)]</p> </td> 
   <td> <p>Geben Sie die E-Mail-UID der E-Mail ein, die Sie löschen möchten.</p> <p>Sie können die UID der E-Mail über das Modul E-Mail &gt; E-Mail ansehen oder das Modul [!UICONTROL Search Email] abrufen.</p> </td> 
  </tr> 
  <tr> 
...
Dieses Aktionsmodul kennzeichnet eine E-Mail oder einen Entwurf in einem ausgewählten Ordner als gelesen, indem es das [!UICONTROL Read]-Flag festlegt.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Email ID (UID)]</p> </td> 
   <td> <p>Geben Sie die E-Mail-UID der E-Mail ein, die Sie als gelesen markieren möchten.</p> <p>Sie können die UID der E-Mail über das Modul E-Mail &gt; E-Mail ansehen oder das Modul [!UICONTROL Search Email] abrufen.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Email ID (UID)]</p> </td> 
   <td> <p>Geben Sie die E-Mail-UID der E-Mail ein, die Sie als ungelesen markieren möchten.</p> <p>Sie können die UID der E-Mail über das Modul E-Mail &gt; E-Mail ansehen oder das Modul [!UICONTROL Search Email] abrufen.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Email ID (UID)]</p> </td> 
   <td> <p>Geben Sie die E-Mail-UID der E-Mail ein, die Sie in den Zielordner verschieben möchten.</p> <p>Sie können die UID der E-Mail über das Modul E-Mail &gt; E-Mail ansehen oder das Modul [!UICONTROL Search Email] abrufen.</p> </td> 
  </tr> 
 </tbody> 
</table>
