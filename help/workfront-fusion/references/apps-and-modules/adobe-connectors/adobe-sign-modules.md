...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Diese Einstellung funktioniert nur für Administratorkonten</p> <p>Klicken Sie für jede E-Mail-Adresse, an die Sie Benachrichtigungen zu Problemen senden möchten, auf <b>[!UICONTROL Add]</b> und geben Sie die E-Mail-Adresse ein.</p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Geben Sie die [!UICONTROL Name] und [!UICONTROL ID] der Gruppe ein oder ordnen Sie sie zu und geben Sie an, ob diese Gruppe die Standardgruppe für das Konto ist.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Library document info]</td> 
   <td> <p>Füllen Sie die folgenden Felder aus:</p> 
    <ul> 
     <li> <p><b>[!UICONTROL Files to send]</b> </p> <p>Klicken Sie für jede Datei, die Sie hinzufügen möchten, auf <b>[!UICONTROL Add item]</b> und füllen Sie die Felder aus.</p> 
      <ul> 
       <li><b>[!UICONTROL Transient document ID]</b> <p>Kennung des vorübergehenden Dokuments eingeben</p> </li> 
     ...
     <li> <p><b>[!UICONTROL Library template name]</b> </p> <p>Namen der Bibliotheksvorlage eingeben oder zuordnen</p> </li> 
     <li> <p><b>[!UICONTROL Sharing mode]</b> </p> <p>Geben Sie an, wer Zugriff auf das Bibliotheksdokument haben soll.</p> </li> 
     ...
     <li> <p><b>[!UICONTROL Library template type]</b> </p> <p>Klicken Sie für jeden Bibliotheksvorlagentyp, den Sie verwenden möchten, auf <b>[!UICONTROL Add item]</b> und wählen Sie den Vorlagentyp aus.</p> </li> 
     <li> <p><b>[!UICONTROL Last event date]</b> </p> <p>Geben Sie das letzte Datum ein, an dem ein Ereignis im Bibliotheksdokument aufgetreten ist.</p> <p>Eine Liste der unterstützten Datums- und Zeitformate finden Sie unter <a href="/help/workfront-fusion/references/mapping-panel/data-types/type-coercion.md" class="MCXref xref">Typzwang in [!DNL Adobe Workfront Fusion]</a>.</p> </li> 
  ...
  <tr> 
   ...
   <td> <p>Füllen Sie die folgenden Felder aus:</p> 
    <ul> 
     ...
     <li> <p><b>[!UICONTROL User ID]</b> </p> <p>Eindeutige ID des Benutzers eingeben</p> </li> 
     <li> <p><b>[!UICONTROL Account ID]</b> </p> <p>Geben Sie die eindeutige ID des [!DNL Adobe Acrobat Sign] Kontos ein, das diesem Benutzer zugeordnet ist.</p> </li> 
     <li> <p><b>[!UICONTROL First name]</b> </p> <p>Geben Sie den Vornamen des Benutzers ein.</p> </li> 
     <li> <p><b>[!UICONTROL Last name]</b> </p> <p>Geben Sie den Nachnamen des Benutzers ein</p> </li> 
     <li> <p><b>[!UICONTROL Company]</b> </p> <p>Geben Sie den Namen der Firma des Benutzers ein.</p> </li> 
     ...
     <li> <p><b>[!UICONTROL Job title]</b> </p> <p>Geben Sie die Stellenbezeichnung des Benutzers ein.</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   ...
   <td> <p>Füllen Sie die folgenden Felder aus</p> 
    <ul> 
     <li> <p><b>[!UICONTROL File info]</b> </p> <p>Klicken Sie für jede Datei, die Sie dem Web-Formular hinzufügen möchten, auf Hinzufügen und füllen Sie die folgenden Felder aus:</p> 
      <ul> 
     ...
     <li> <p><b>[!UICONTROL Web form name]</b> </p> <p>Geben Sie einen Namen für das Web-Formular ein. Dieser Name wird verwendet, um das Web-Formular an Stellen wie E-Mails und Websites zu identifizieren.</p> </li> 
     <li> <p><b>[!UICONTROL Web form state]</b> </p> <p>Wählen Sie den Status aus, in dem das neue Web-Formular erstellt werden soll.</p> </li> 
     <li> <p><b>[!UICONTROL Web form participant set info]</b> </p> 
      <ul> 
       <li> <p><b>[!UICONTROL Member info]</b> </p> <p>Klicken Sie für jedes Mitglied, das Sie zum Teilnehmerset hinzufügen möchten, auf <b>[!UICONTROL Add item]</b>. </p> 
        <ul> 
         <li> <p><b>[!UICONTROL Email]</b> </p> <p>Lassen Sie diese Option leer.</p> </li> 
         <li> <p><b>[!UICONTROL Security option]</b> </p> <p>Wenn Sie eine Sicherheitsoption zur Authentifizierung dieses Benutzers hinzufügen möchten, wählen Sie <b>[!UICONTROL Yes]</b> aus, wählen Sie dann die Sicherheitsoption aus und füllen Sie alle erforderlichen Felder aus.</p> </li> 
        </ul> </li> 
     ...
     <li> <p><b>[!UICONTROL Authentication failure info]</b> </p> <p>Wenn Sie eine Fehler- oder Fehlerseite für Ihre Benutzer bereitstellen möchten, wählen Sie <b>[!UICONTROL Yes]</b> aus und füllen Sie dann die folgenden Felder aus:</p> 
      <ul> 
     ...
     <li> <p><b>[!UICONTROL CC info]</b> </p> <p>Klicken Sie für jede E-Mail-Adresse, die Sie bei Unterzeichnung der endgültigen Vereinbarung im Web-Formular per E-Mail erhalten möchten, auf <b>[!UICONTROL Add item]</b> und geben Sie die E-Mail-Adresse ein.</p> </li> 
     <li> <p><b>[!UICONTROL Completion info]</b> </p> <p style="font-style: normal;">Wenn Sie eine Erfolgsseite für Ihre Benutzer bereitstellen möchten, wählen Sie <b>[!UICONTROL Yes]</b> aus und füllen Sie dann die folgenden Felder aus:</p> 
      <ul> 
     ...
     <li> <p><b>[!UICONTROL Group ID]</b> </p> <p>Geben Sie die ID der Gruppe ein, zu der das Web-Formular gehört. Wenn nichts eingegeben wird, gehört das Web-Formular zur primären Gruppe des Kontobenutzers.</p> </li> 
     <li> <p><b>[!UICONTROL Last event date]</b> </p> <p>Geben Sie das Datum ein, an dem das letzte Ereignis im Web-Formular aufgetreten ist. Verwenden Sie den <code>yyyy-MM-dd'T'HH:mm:ssZ</code>.</p> </li> 
     <li> <p><b>[!UICONTROL Locale]</b> </p> <p>Geben Sie das Gebietsschema des Benutzers ein. Dadurch wird die Sprache der Benutzeroberfläche bestimmt. </p> </li> 
     <li> <p><b>[!UICONTROL Security optio]n</b> </p> <p>Geben Sie das Kennwort zum Schützen des Dokuments ein. Sie müssen dieses Passwort den relevanten Parteien separat mitteilen.</p> </li> 
...
>[!NOTE]
>
>Es wird empfohlen, das Dokument zum Signieren als vorübergehendes Dokument hochzuladen und es dann dem Feld [!UICONTROL File to send] im Modul [!UICONTROL Create an agreement] zuzuordnen. Ein Beispiel finden Sie unter „Dokument hochladen“ in diesem Artikel.
...
<td>Anweisungen zum Verbinden Ihres [!DNL Adobe Acrobat Sign]-Kontos mit [!DNL Workfront Fusion] finden Sie unter <a href="/help/workfront-fusion/create-scenarios/connect-to-apps/connect-to-fusion-general.md" class="MCXref xref">Erstellen einer Verbindung zu [!DNL Adobe Workfront Fusion] - Grundlegende Anweisungen</a></td>  </tr> 
  ...
  <tr> 
   ...
   <td> <p>Klicken Sie für jedes Element, das Sie in die Vereinbarung aufnehmen möchten, auf <b>[!UICONTROL Add Item]</b> und füllen Sie die folgenden Felder aus:</p> 
    <ul> 
     <li> <p><b>[!UICONTROL File Type]</b> </p> 
      <ul> 
       <li> <p><b>[!UICONTROL Document]</b> </p> <p>Füllen Sie die folgenden Felder aus:</p> 
        <ul> 
         <li> <p><b>[!UICONTROL Created date]</b> </p> <p>Geben Sie das Datum, an dem das Dokument erstellt wurde, im Format <code>yyyy-MM-dd'T'HH:mm:ssZ</code> ein oder ordnen Sie es zu. Beispiel: <code>2016-02-25T18:46:19Z</code> stellt die UTC-Zeit dar.</p> </li> 
         ...
         <li> <p><b>[!UICONTROL Number of pages]</b> </p> <p>Geben Sie die Anzahl der Seiten im Dokument ein oder mappen Sie sie.</p> </li> 
       ...
       <li> <p><b>[!UICONTROL Transient document ID]</b> </p> <p>Kennung des vorübergehenden Dokuments eingeben</p> </li> 
       <li> <p><b>[!UICONTROL URL file transfer]</b> </p> <p>Füllen Sie die folgenden Felder aus:</p> 
        <ul> 
         <li> <p><b>[!UICONTROL Mime-Type]</b> </p> <p>Geben Sie den MIME-Typ der Originaldatei an. MIME-Typen (Multipurpose Internet Mail Extension) sind Bezeichnungen, mit denen Software verschiedene Arten von im Internet freigegebenen Daten identifizieren kann. Webserver und Browser verwenden den MIME-Typ, um zu bestimmen, was mit einer Datei getan werden soll. Beispielsweise wird eine Datei mit dem MIME-Typ <code>text/html</code> in einem Browser anders verarbeitet als eine Datei mit dem MIME-Typ <code>image/jpeg</code>.</p> </li> 
         <li> <p><b>[!UICONTROL Name]</b> </p> <p>Geben Sie einen Namen für die Datei ein.</p> </li> 
  ...
  <tr> 
   ...
   <td> <p>Klicken Sie für jedes Teilnehmerset, das Sie hinzufügen möchten, auf <b>[!UICONTROL Add item]</b> und füllen Sie die folgenden Felder aus.</p> 
    <ul> 
     <li> <p><b>[!UICONTROL Members]</b> </p> <p>Klicken Sie für jede Person, die Sie zum Teilnehmerset hinzufügen möchten, auf <b>[!UICONTROL Add item]</b> und geben Sie die E-Mail-Adresse der Person ein.</p> </li> 
     ...
     <li> <p><b>[!UICONTROL Private message]</b> </p> <p>Geben Sie eine Nachricht für dieses Teilnehmerset ein oder ordnen Sie sie zu. Alle Teilnehmer des Sets erhalten diese Nachricht.</p> </li> 
     <li> <p><b>[!UICONTROL Visible pages]</b> </p> <p>Wenn für diese Vereinbarung die eingeschränkte Dokumentsichtbarkeit aktiviert ist, geben Sie an, welche Dateien für diese Teilnehmergruppe sichtbar sein sollen. </p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>Sie können diese Vereinbarung an Interessenten senden, die sie nicht unterzeichnen müssen, z. B. Stakeholder. Sie erhalten eine E-Mail zu Beginn des Signiervorgangs und eine weitere, wenn die endgültige Signatur empfangen wird. Sie erhalten auch eine PDF-Kopie des Vertrags. </p> <p>Klicken Sie für jede Person, die Sie diesen Vertrag mit CC abschließen möchten, auf <b>[!UICONTROL Add item]</b> und füllen Sie die folgenden Felder aus:</p> 
    <ul> 
  ...
  <tr> 
   ...
   <td> <p>Wählen Sie für jeden E-Mail-Typ aus, ob dieser E-Mail-Typ an alle Teilnehmer gesendet werden soll oder nicht.</p> 
    <ul> 
     <li> <p><b>[!UICONTROL Completion emails]</b> </p> <p>Senden Sie eine E-Mail, wenn dieser Vertrag abgeschlossen, gekündigt, abgelaufen oder abgelehnt wurde.</p> </li> 
     <li> <p><b>[!UICONTROL In-Flight emails]</b> </p> <p>Eine E-Mail wurde gesendet, wenn diese Vereinbarung delegiert oder ersetzt wurde.</p> </li> 
     <li> <p><b>[!UICONTROL Agreement initiation emails]</b> </p> <p>Senden Sie eine E-Mail, wenn diese Vereinbarung erstellt wird oder eine Aktion dafür angefordert wird.</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>Klicken Sie für jedes Feld in der Vereinbarung, für das Sie einen Standardwert festlegen möchten, auf <b>[!UICONTROL Add item]</b> und geben Sie den Standardwert und den Feldnamen ein.</p> <p>Die Werte werden den Unterzeichnern für bearbeitbare Felder angezeigt. Für schreibgeschützte Felder sind die angegebenen Werte während des Signiervorgangs nicht bearbeitbar.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Notary info]</td> 
   <td> <p>Füllen Sie die folgenden Felder aus:</p> 
    <ul> 
     <li> <p><b>[!UICONTROL Appointment]</b> </p> <p>Geben Sie eine vorgeschlagene Uhrzeit und ein Datum für die Ernennung ein, um diese Vereinbarung zu beglaubigen, oder kartieren Sie sie.</p> </li> 
     <li> <p><b>[!UICONTROL Note]</b> </p> <p>Geben Sie alle Notizen ein, die Sie über die Notarsitzung einbeziehen möchten, oder mappen Sie sie.</p> </li> 
     <li> <p><b>[!UICONTROL Payment]</b> </p> <p>Wählen Sie aus, ob der Notar vom Unterzeichner oder vom Absender der Vereinbarung bezahlt wird.</p> </li> 
     <li> <p><b>[!UICONTROL Notary Type]</b> </p> <p>Notartyp auswählen</p> 
      <ul> 
       <li> <p>[!UICONTROL Provider notary]</p> <p>Der Notar wird vom notariellen Leistungserbringer gestellt.</p> </li> 
       <li> <p>[!UICONTROL BYON notary]</p> <p>Der Notar wird vom Kunden gestellt.</p> </li> 
      </ul> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Wählen Sie den Typ des zugehörigen Felds aus, das Sie erstellen möchten</p> 
    <ul> 
     <li> <p><b>[!UICONTROL Form fields]</b> </p> <p>Geben Sie die Vorlagen-ID der Vorlage ein, die die zu erstellenden Felder enthält</p> </li> 
     <li> <p><b>[!UICONTROL Reminders]</b> </p> <p>Füllen Sie die folgenden Felder aus:</p> 
      <ul> 
       <li> <p><b>[!UICONTROL Recipient participant ID]</b> </p> <p>Klicken Sie für jeden Teilnehmer, für den Sie eine Erinnerung erhalten möchten, auf [!UICONTROL Add item] und geben Sie die ID des Teilnehmers ein.</p> </li> 
       <li> <p><b>[!UICONTROL Status]</b> </p> <p>Für neue Datensätze muss der Status [!UICONTROL Active] sein.</p> </li> 
       <li> <p><b>[!UICONTROL First reminder delay]</b> </p> <p>Geben Sie die Verzögerung in Stunden vor dem Senden der ersten Erinnerung ein. Der zulässige Mindestwert ist 1 Stunde, und der Höchstwert darf nicht größer sein als die Differenz zwischen der Erstellung der Vereinbarung und der Ablaufzeit der Vereinbarung in Stunden. Wenn diese Verzögerung nicht festgelegt ist, basiert die erste Erinnerung auf der Häufigkeit.</p> </li> 
       <li> <p><b>[!UICONTROL Reminder frequency]</b> </p> <p>Legen Sie fest, wie häufig die Erinnerung gesendet werden soll. Wenn keine Häufigkeit angegeben wird, wird die Erinnerung einmal gesendet.</p> </li> 
       <li> <p><b>[!UICONTROL Last sent date]</b> </p> <p>Dieses Feld wird vom System festgelegt.</p> </li> 
       <li> <p><b>[!UICONTROL Next sent date]</b> </p> <p>Dieses Feld muss leer sein oder auf [!UICONTROL ONCE] gesetzt werden.</p> </li> 
       <li> <p><b>[!UICONTROL Note]</b> </p> <p>Geben Sie eine Notiz ein, die in die Erinnerung aufgenommen werden soll. Dies ist nützlich, um dem Teilnehmer zu sagen, warum seine Teilnahme erforderlich ist.</p> </li> 
       <li> <p><b>[!UICONTROL Start reminder counter from]</b> </p> <p>Wählen Sie aus, ob die Erinnerung basierend auf dem Zeitpunkt gesendet wird, zu dem die Vereinbarung erstellt wurde, sobald sie verfügbar wird.</p> </li> 
      </ul> </li> 
     <li> <p><b>[!UICONTROL Signer identity report]</b> </p> <p>Geben Sie das Kennwort zum Schützen des PDF-Dokuments ein.</p> </li> 
     <li> <p><b>[!UICONTROL Views]</b> </p> <p>Folgende Felder eingeben</p> 
      <ul> 
       ...
       <li> <p><b>[!UICONTROL Auto login user]</b> </p> <p>Wählen Sie <b>[!UICONTROL Yes]</b> aus, um den Benutzer automatisch bei der zurückgegebenen URL anzumelden.</p> </li> 
       <li> <p><b>[!UICONTROL Frame Parent]</b> </p> <p>Geben Sie eine kommagetrennte Liste der URLs der übergeordneten Domain ein, in der die zurückgegebenen URLs eingerahmt werden können, oder ordnen Sie sie zu. Wenn Sie das Feld leer lassen, können die [!DNL Adobe Acrobat Sign]-Seiten nicht in iframe angezeigt werden.</p> </li> 
       <li> <p><b>[!UICONTROL Locale]</b> </p> <p>Geben Sie die Sprache ein, in der Sie die Ansicht erstellen möchten. </p> </li> 
       <li> <p><b>[!UICONTROL No chrome flag]</b> </p> <p>Wählen Sie <b>[!UICONTROL Yes]</b> aus, um die eingebettete Seite ohne Navigationskopfzeile oder -fußzeile anzuzeigen.</p> </li> 
       <li> <p><b>[!UICONTROL Can edit files]</b> </p> <p>Wählen Sie <b>[!UICONTROL Yes]</b> aus, wenn der Abschnitt „Datei-Upload“ durch Hinzufügen oder Entfernen von Dateien bearbeitet werden soll. Dies ist kein Zugriffskontrollmechanismus. Der Standardwert lautet [!UICONTROL Yes].</p> </li> 
       <li> <p><b>[!UICONTROL Library document]</b> </p> <p>Wählen Sie <b>[!UICONTROL Yes]</b> aus, wenn Links zu Bibliotheksdokumenten sichtbar sein sollen. Der Standardwert lautet [!UICONTROL Yes].</p> </li> 
       <li> <p><b>[!UICONTROL Local file]</b> </p> <p>Wählen Sie <b>[!UICONTROL Yes]</b> aus, wenn die Schaltfläche Lokaler Datei-Upload angezeigt werden soll. Der Standardwert lautet [!UICONTROL Yes].</p> </li> 
       <li> <p><b>[!UICONTROL Web connectors]</b> </p> <p>Wählen Sie <b>[!UICONTROL Yes]</b> aus, wenn die Links zum Anhängen von Dokumenten aus Web-Quellen angezeigt werden sollen. Der Standardwert lautet Ja.</p> </li> 
       <li> <p><b>[!UICONTROL Is preview selected]</b> </p> <p>Wählen Sie <b>[!UICONTROL Yes]</b> aus, um für die Seite „Erstellen“ den Authoring-Modus festzulegen.</p> </li> 
      </ul> </li> 
     <li> <p><b>[!UICONTROL Member share]</b> </p> <p>Klicken Sie für jedes Mitglied, für das Sie die Vereinbarung freigeben möchten, auf <b>[!UICONTROL Add item]</b> und geben Sie die E-Mail-Adresse des Mitglieds und eine Nachricht an dieses Mitglied ein.</p> </li> 
     <li> <p>[!UICONTROL Delegate participant set]</p> 
      <ul> 
       <li> <p><b>[!UICONTROL Participant set ID]</b> </p> <p>ID des Teilnehmersatzes eingeben</p> </li> 
       <li> <p><b>[!UICONTROL Member info]</b> </p> <p>Klicken Sie für jedes Mitglied, das Sie hinzufügen möchten, auf [!UICONTROL Add item] und geben Sie die E-Mail-Adresse und die Telefoninformationen für das Mitglied ein.</p> </li> 
       <li> <p><b>[!UICONTROL Private message]</b> </p> <p>Eine Nachricht eingeben. Alle Mitglieder des Teilnehmersatzes erhalten diese Nachricht.</p> </li> 
      </ul> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   ...
   <td> <p>Füllen Sie die folgenden Felder aus:</p> 
    <ul> 
     ...
     <li> <p><b>[!UICONTROL Locale]</b> </p> <p>Geben Sie die Sprache ein, in der Sie die Ansicht erstellen möchten. </p> </li> 
     <li> <p><b>[!UICONTROL No chrome flag]</b> </p> <p>Wählen Sie <b>[!UICONTROL Yes]</b> aus, um die eingebettete Seite ohne Navigationskopfzeile oder -fußzeile anzuzeigen.</p> </li> 
     <li> <p><b>[!UICONTROL Send view configuration]</b> </p> <p>Wählen Sie <b>[!UICONTROL Yes]</b> aus, wenn Sie die [!UICONTROL Send] konfigurieren möchten, und füllen Sie dann die folgenden Felder aus.</p> 
      <ul> 
       <li> <p><b>[!UICONTROL Agreement name]</b> </p> <p>Geben Sie den Namen der Vereinbarung für das Bibliotheksdokument auf der Erstellungsseite ein oder ordnen Sie ihn zu.</p> </li> 
       <li> <p><b>[!UICONTROL Can edit files]</b> </p> <p>Wählen Sie <b>[!UICONTROL Yes]</b> aus, wenn der Abschnitt „Datei-Upload“ durch Hinzufügen oder Entfernen von Dateien bearbeitet werden soll. Dies ist kein Zugriffskontrollmechanismus. Der Standardwert lautet [!UICONTROL Yes].</p> </li> 
       <li> <p><b>[!UICONTROL Local file]</b> </p> <p>Wählen Sie <b>[!UICONTROL Yes]</b> aus, wenn Links zu Bibliotheksdokumenten sichtbar sein sollen. Der Standardwert lautet [!UICONTROL Yes].</p> </li> 
       <li> <p><b>[!UICONTROL Web connectors]</b> </p> <p>Wählen Sie <b>[!UICONTROL Yes]</b> aus, wenn die Links zum Anhängen von Dokumenten aus Web-Quellen angezeigt werden sollen. Der Standardwert lautet [!UICONTROL Yes].</p> </li> 
       <li> <p><b>Ist Vorschau ausgewählt</b> </p> <p>Wählen Sie <b>[!UICONTROL Yes]</b> aus, um für die Seite „Erstellen“ den Authoring-Modus festzulegen.</p> </li> 
      </ul> <p> </p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   ...
   <td> <p>Füllen Sie die folgenden Felder aus</p> 
    <ul> 
     ...
     <li> <p><b>[!UICONTROL Auto login user]</b> </p> <p>Wählen Sie <b>[!UICONTROL Yes]</b> aus, um den Benutzer automatisch anzumelden. Wählen Sie <b>[!UICONTROL No]</b> aus, um Anmeldeinformationen anzufordern. Der Standardwert lautet [!UICONTROL No].</p> </li> 
     <li> <p><b>[!UICONTROL Frame parent]</b> </p> <p>Geben Sie eine kommagetrennte Liste der URLs der übergeordneten Domain ein, in der die zurückgegebenen URLs eingerahmt werden können, oder ordnen Sie sie zu. Wenn Sie das Feld leer lassen, können die [!DNL Adobe Acrobat Sign]-Seiten nicht in iframe angezeigt werden.</p> </li> 
  ...
  <tr> 
   ...
   <td> <p>Wählen Sie den entsprechenden Datensatz aus, den Sie erstellen möchten.</p> 
    <ul> 
     <li> <p>[!UICONTROL Views]</p> <p>Füllen Sie die folgenden Felder aus.</p> 
      <ul> 
       ...
       <li> <p><b>[!UICONTROL Locale]</b> </p> <p>Geben Sie die Sprache ein, in der Sie die Ansicht erstellen möchten. </p> </li> 
       <li> <p><b>[!UICONTROL No chrome flag]</b> </p> <p>Wählen Sie <b>[!UICONTROL Yes]</b> aus, um die eingebettete Seite ohne Navigationskopfzeile oder -fußzeile anzuzeigen.</p> </li> 
       <li> <p>[!UICONTROL Personalized signing view configuration]</p> <p>Wenn Sie eine personalisierte Signaturansicht konfigurieren möchten, wählen Sie <b>[!UICONTROL Yes]</b> aus und füllen Sie die folgenden Felder aus:</p> 
        <ul> 
         ...
         <li> <p><b>[!UICONTROL Expiration]</b> </p> <p>Geben Sie ein Ablaufdatum für die Personalisierung dieses Web-Formulars ein. </p> <p>Eine Liste der unterstützten Datums- und Zeitformate finden Sie unter <a href="/help/workfront-fusion/references/mapping-panel/data-types/type-coercion.md" class="MCXref xref" data-mc-variable-override="">Typzwang in [!DNL Adobe Workfront Fusion]</a>.</p> </li> 
         <li> <p><b>[!UICONTROL Reusable]</b> </p> <p>Wählen Sie <b>[!UICONTROL Yes]</b> aus, wenn der vorgesehene Unterzeichner das Formular mehrmals signieren können soll.</p> </li> 
        </ul> </li> 
      </ul> </li> 
     <li> <p><b>[!UICONTROL Member share]</b> </p> <p>Klicken Sie für jedes Mitglied, für das Sie die Vereinbarung freigeben möchten, auf <b>[!UICONTROL Add item]</b> und geben Sie die E-Mail-Adresse des Mitglieds und eine Nachricht an dieses Mitglied ein.</p> </li> 
    </ul> </td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Geben Sie die Nummer des ersten Datensatzes ein, den das Modul zurückgeben soll. </p> <p>Hinweis: Dieses Feld ist mit dem [!UICONTROL Maximum number of returned records] Feld für die Paginierung kombiniert. Wenn der [!UICONTROL Maximum number of returned events] beispielsweise 100 und der [!UICONTROL Start index] 101 ist, gibt das Modul die Datensätze 101-200 oder die zweite Ergebnisseite zurück.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Maximum number of returned records]</td> 
   <td> <p>Geben Sie die maximale Anzahl von Datensätzen ein, denen das Modul während jedes Szenario-Ausführungszyklus [Aktion] zugeordnet werden soll.</p> <p>Hinweis: Dieses Feld wird mit dem [!UICONTROL Cursor]- oder [!UICONTROL Start Index]-Feld für die Paginierung kombiniert. Wenn der [!UICONTROL Maximum number of returned events] beispielsweise 100 und der [!UICONTROL Start index] 101 ist, gibt das Modul die Datensätze 101-200 oder die zweite Ergebnisseite zurück.</p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL Record ID] (Beispiel: [!UICONTROL Account ID])</td> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Geben Sie Informationen in bestimmte Felder basierend auf dem Datensatztyp und verwandten Feldern ein.</p> 
    <ul> 
     <li> <p><b>[!UICONTROL Agreement]</b> </p> <p>Wenn Sie wesentliche Änderungen an einem Abkommen erwarten, empfehlen wir als Best Practice die Erstellung eines neuen Abkommens, anstatt das bestehende zu aktualisieren.</p> </li> 
     <li> <p><b>[!UICONTROL Library document]</b> </p> <p>Wählen Sie die Felder aus, die Sie aktualisieren möchten, und füllen Sie dann die ausgewählten Felder aus:</p> 
      <ul> 
     ...
     <li> <p><b>[!UICONTROL User]</b> </p> <p>Wählen Sie die Felder aus, die Sie aktualisieren möchten, und füllen Sie dann die ausgewählten Felder aus:</p> 
      <ul> 
       ...
       <li> <p><b>[!UICONTROL Company]</b> </p> <p>Geben Sie den Namen der Firma des Benutzers ein.</p> </li> 
       <li> <p><b>[!UICONTROL Phone]</b> </p> <p>Telefonnummer des Benutzers eingeben</p> </li> 
       <li> <p><b>[!UICONTROL Primary group ID]</b> </p> <p>Geben Sie die Gruppe ein, der der neue Benutzer hinzugefügt wird. Wenn nichts eingegeben wird, wird der Benutzer der Standardgruppe für das Konto hinzugefügt.</p> </li> 
       <li> <p><b>[!UICONTROL Job title]</b> </p> <p>Geben Sie die Stellenbezeichnung des Benutzers ein.</p> </li> 
      </ul> </li> 
     <li> <p><b>[!UICONTROL Web form] ([!UICONTROL widget])</b> </p> <p>Geben Sie Informationen in bestimmte Felder basierend auf dem Datensatztyp und verwandten Feldern ein.</p> </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
    ...
    <ul> 
     ...
     <li> <p><b>[!UICONTROL Library document]</b> </p> <p>Wählen Sie die Felder aus, die Sie aktualisieren möchten, und füllen Sie dann die ausgewählten Felder aus:</p> 
      <ul> 
       ...
       <li> <p><b>[!UICONTROL Note]</b> </p> <p>Geben Sie den Text der Anmerkung ein oder mappen Sie ihn.</p> </li> 
      ...
      <ul> 
       <li> <p><b>[!UICONTROL Group info list]</b> </p> <p>Füllen Sie die folgenden Felder aus</p> 
        <ul> 
         ...
         <li> <p><b>[!UICONTROL Is group admin]</b> </p> <p>Wählen Sie <b>[!UICONTROL Yes]</b> aus, um diesen Benutzer zum Gruppenadministrator zu machen.</p> </li> 
         ...
         <li> <p><b>[!UICONTROL Created date]</b> </p> <p>Geben Sie das Datum ein, an dem die Gruppe erstellt wurde.</p> <p>Eine Liste der unterstützten Datums- und Zeitformate finden Sie unter <a href="/help/workfront-fusion/references/mapping-panel/data-types/type-coercion.md" class="MCXref xref" data-mc-variable-override="">Typzwang in [!UICONTROL Adobe Workfront Fusion]</a>.</p> </li> 
         ...
         <li> <p><b>[!UICONTROL Library document creation visible]</b> </p> <p>Diese Einstellungen bestimmen, ob der Benutzer Bibliotheksdokumente erstellen kann</p> 
          <ul> 
           <li> <p>[!UICONTROL Value]</p> <p>zulassen</p> </li> 
           <li> <p>[!UICONTROL Inherited]</p> <p>Gruppeneinstellungen von Gruppe oder Konto übernehmen</p> </li> 
          </ul> </li> 
         <li> <p><b>[!UICONTROL Send restricted to workflows]</b> </p> <p>Diese Einstellungen bestimmen, ob der Benutzer Vereinbarungen nur mithilfe von Workflows erstellen kann.</p> 
          <ul> 
           <li> <p>[!UICONTROL Value]</p> <p>zulassen</p> </li> 
           <li> <p>[!UICONTROL Inherited]</p> <p>Gruppeneinstellungen von Gruppe oder Konto übernehmen</p> </li> 
          </ul> </li> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Nach Text in den Metadaten der Vereinbarung suchen. </p> 
    <ul> 
     <li> <p><b>[!UICONTROL Find text]</b> </p> <p>Geben Sie den Text ein, den Sie in den Vereinbarungsmetadaten finden möchten. Jedes Wort wird als separates Textelement behandelt. </p> </li> 
     <li> <p><b>[!UICONTROL Find text in]</b> </p> <p>Wählen Sie die Metadatenfelder aus, in denen Sie Text suchen möchten. Wenn Sie nichts auswählen, durchsuchen die Module alle Metadaten.</p> </li> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL External ID]</td> 
   <td> <p> Die externe ID ist eine vom Absender zugewiesene ID der Vereinbarung, die in jeder Form vorliegen kann, üblicherweise jedoch in Form von "&lt;groupID&gt;:&lt;ID&gt;".</p> <p>Klicken Sie für jede externe ID, die Sie hinzufügen möchten, auf <b>[!UICONTROL Add]</b> und geben Sie die externe ID ein oder ordnen Sie sie zu.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Group ID]</td> 
   <td> <p>Die Gruppen-ID ist eine Kennung, die bei der Erstellung der Gruppe zugewiesen wurde.</p> <p>Klicken Sie für jede externe ID, die Sie hinzufügen möchten, auf <b>[!UICONTROL Add]</b> und geben Sie die externe ID ein oder ordnen Sie sie zu.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Asset ID]</td> 
   <td> <p>Dies ist die ID, die der spezifischen Vereinbarung zugewiesen wurde. </p> <p>Klicken Sie für jede externe ID, die Sie hinzufügen möchten, auf <b>[!UICONTROL Add]</b> und geben Sie die externe ID ein oder ordnen Sie sie zu.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Parent ID]</td> 
   <td> <p>Dies ist die ID, die dem übergeordneten Objekt der Vereinbarung zugewiesen ist. </p> <p>Klicken Sie für jede externe ID, die Sie hinzufügen möchten, auf <b>[!UICONTROL Add]</b> und geben Sie die externe ID ein oder ordnen Sie sie zu.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Participant email]</td> 
   <td> <p>Die E-Mail-Adresse eines Teilnehmers. </p> <p>Klicken Sie für jede externe ID, die Sie hinzufügen möchten, auf <b>[!UICONTROL Add]</b> und geben Sie die externe ID ein oder ordnen Sie sie zu.</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>Die Benutzer-ID des Benutzers, für den die Vereinbarung freigegeben wurde.</p> <p>Klicken Sie für jede Benutzer-ID, die Sie hinzufügen möchten, auf <b>[!UICONTROL Add]</b> und geben Sie die Benutzer-ID ein oder ordnen Sie sie zu.</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>Geben Sie die Position des ersten Ergebnisses ein, das Sie zurückgeben möchten. Kombinieren Sie dies mit dem [!UICONTROL maximum returned results], um Ergebnisse zu paginieren</p> <p>Beispiel: Wenn Sie 100 Ergebnisse gleichzeitig zurückgeben, geben Sie 100 ein, um Ergebnisse 100-200 zurückzugeben.</p> </td> 
  </tr> 
  <tr> 
