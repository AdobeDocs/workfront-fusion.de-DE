...
## [!UICONTROL HTML in Markdown]

Dieses Modul konvertiert HTML-Code in Markdown.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL bereinigen]</td> 
   <td>Wählen Sie eine Option aus, um anzugeben, ob Sie HTML-Tags aus dem Text entfernen oder HTML mit Escape-Zeichen versehen möchten.</td> 
  </tr> 
 </tbody> 
</table>
