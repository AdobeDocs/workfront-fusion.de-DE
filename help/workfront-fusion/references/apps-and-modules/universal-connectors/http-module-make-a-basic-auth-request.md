...
Beim Konfigurieren des Moduls [!UICONTROL HTTP] > [!UICONTROL Einfache Autorisierungsanfrage stellen] zeigt Adobe Workfront Fusion die unten aufgeführten Felder an. Ein fett gedruckter Titel in einem Modul gibt ein erforderliches Feld an.
