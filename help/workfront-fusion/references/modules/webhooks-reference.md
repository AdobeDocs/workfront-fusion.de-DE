...
1. Um Ereignisabonnements anzuzeigen, die mit einem Workfront-Webhook verknüpft sind, aktivieren Sie das Kontrollkästchen neben dem Webhook und wählen **Details anzeigen** unten auf der Seite aus.
   ...
   >[!NOTE]
   >
   > Details zum Ereignisabonnement sind nur für Workfront-Webhooks verfügbar, die im neuen Workfront-Connector erstellt wurden. Webhook-Details sind derzeit nicht für andere Connectoren verfügbar.
