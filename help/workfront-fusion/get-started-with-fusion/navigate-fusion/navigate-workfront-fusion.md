...
description: Wenn Sie Fusion öffnen, stehen Ihnen zahlreiche Aktionsoptionen zur Verfügung. In diesem Artikel erfahren Sie, wie Sie hiervon ausgehend weiter vorgehen können.
author: Becky
...
Über das linke Navigations-Panel können Sie durch die verschiedenen Bereiche von Adobe Workfront Fusion navigieren. Hier finden Sie alle wichtigen Bereiche von Fusion und können schnell zwischen ihnen wechseln.
...
| Verbindungen <br> ![Verbindungssymbol](assets/connections-icon.png) | Verbindungen enthalten Anmeldeinformationen und Berechtigungen, die es Fusion ermöglichen, mit anderen Anwendungen zu interagieren. Sie erstellen eine Verbindung mit einem bestimmten Satz von Anmeldeinformationen und Berechtigungen für ein bestimmtes Programm und verwenden diese Verbindung dann in Ihrem Szenario. Das Szenario kann daraufhin die Einträge oder andere Daten, die einer Person mit diesen Anmeldeinformationen und Berechtigungen zur Verfügung stehen, abrufen und ändern. Sie können mehrere Verbindungen für eine Anwendung erstellen und eine Verbindung in mehreren Szenarios verwenden. Im Bereich „Verbindungen“ können Sie eine Liste der von Ihrem Team eingerichteten Verbindungen anzeigen und verwalten. | [Überblick über Verbindungen](/help/workfront-fusion/get-started-with-fusion/understand-fusion/connection-overview.md) |
| Webhooks <br> ![Webhook-Symbol](assets/webhooks-icon.png) | Webhooks überwachen Anwendungen auf Änderungen und starten dann ein Szenario, das auf dieser Änderung basiert. Sie können beispielsweise einen Webhook so konfigurieren, dass ein Szenario gestartet wird, wenn ein Problem an ein bestimmtes Workfront-Projekt gesendet wird. Im Bereich „Webhooks“ sehen Sie eine Liste der von Ihrem Team konfigurierten Webhooks und die Szenarios, in denen sie verwendet werden. | [Instant-Auslöser (Webhooks)](/help/workfront-fusion/references/modules/webhooks-reference.md) |
...
>[!NOTE]
>
>Alle Bereiche unter der Überschrift „Team“ gehören einzelnen Teams. Um die Seite anzuzeigen, die zu einem anderen Team gehört (z. B. die Seite „Szenarios“ eines anderen Teams), klicken Sie oben auf der Seite auf das Dropdown-Menü „Team“ und wählen Sie ein anderes Team aus.
