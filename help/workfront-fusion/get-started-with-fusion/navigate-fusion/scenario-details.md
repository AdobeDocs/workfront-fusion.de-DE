...
description: Szenario-Details in [!DNL Adobe Workfront Fusion]
author: Becky
...
## Öffnen Sie die [!UICONTROL Scenario detail] Seite:
...
1. Auf der angezeigten Seite können Sie die in der folgenden Tabelle aufgelisteten Elemente überprüfen:
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      <td role="rowheader">[!UICONTROL Reports] Tabulator </td> 
     ...
     <tr> 
      <td role="rowheader">[!UICONTROL History] Tabulator </td> 
      <td> <p>Öffnen Sie diese Registerkarte, um einen Verlauf des Szenarios anzuzeigen, einschließlich der Änderungen am Szenario. </p> <p>Auf der Registerkarte [!UICONTROL History] finden Sie außerdem den Ausführungsverlauf des Szenarios für jede Ausführung, der Folgendes umfasst:</p> 
       <ul> 
     ...
     <tr> 
      <td role="rowheader">[!UICONTROL Activate scenario] (Ein/Aus-Taste)</td> 
     ...
     <tr> 
      <td role="rowheader"> <p>[!UICONTROL History] Bedienfeld</p> <p> </p> </td> 
      <td> <p>Dieser Bereich enthält Informationen zu den letzten Ausführungen des Szenarios. Für jeden Durchgang wird Folgendes angezeigt:</p> 
       <ul> 
        ...
        <li>Link zu detaillierten Informationen</li> 
         ...
         <tr> 
      <td role="rowheader"> <p>[!UICONTROL Events] Bedienfeld</p>  </td> 
